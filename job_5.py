...
df_autuacao_analise_1_.to_csv(r'gs://datasets/diego_autuacao_analise_1.csv')
...
df_autuacao_analise_2_.to_csv(r'gs://datasets/diego_autuacao_analise_2.csv')
...
df_autuacao_diego_analise_3_.to_csv(r'gs://datasets/diego_distribuicao_analise_4.csv')
...
df_estados.to_csv(r'gs://datasets/sandi_rayssa_estados_ferro.csv')
print(df_estados)
...
df_empreendedor.to_csv(r'gs://datasets/sandi_rayssa_empreendedor.csv')
...
df_beneficiada_total_vendas_ferro_1.to_csv(r'gs://datasets/analise_ferro_venda_brasil.csv')
...
df_beneficiada_analise_1.to_csv(r'gs://datasets/sandi_rayssa_beneficiada_analise_producao.csv')
...
df_beneficiada_analise_venda_1.to_csv(r'gs://datasets/sandi_rayssa_beneficiada_analise_venda_1.csv')
...
df_beneficiada_analise_venda_2.to_csv(r'gs://datasets/sandi_rayssa_beneficiada_analise_venda_2.csv')
...
df_analise_rafa_1.to_csv(r'gs://datasets/rafael_analise_1.csv')
...
df_analise_rafa_2.to_csv(r'gs://datasets/2_analise_rafa.csv')
...
df_analise_rafa_3_0.to_csv(r'gs://datasets/3_0_analise_rafa.csv')
...
df_analise_rafa_3_1.to_csv(r'gs://datasets/3_1_analise_rafa.csv')
...
df_analise_rafa_4.to_csv(r'gs://datasets/4_analise_rafa.csv')
...
df_analise_rafa_4_1.to_csv(r'gs://datasets/4_1_analise_rafa.csv')
...
df_analise_rafa_5.to_csv(r'gs://datasets/5_analise_rafa.csv')
...
df_analise_rafa_6.to_csv(r'gs://datasets/6_analise_rafa.csv')
...
df_analise_rafa_7.to_csv(r'gs://datasets/7_analise_rafa.csv')
